...
- Added a build-time Supabase environment check so Vercel fails fast when public auth keys are missing, placeholders, malformed, or from a different Supabase project.
